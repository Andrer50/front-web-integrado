  ...
  const quickActions = [
    {
      title: "Reservar cita",
      icon: Calendar,
      color: "bg-blanco-azulado text-celeste",
      route: "/dashboard/patient/my-appointments/reservation",
    },
    {
      title: "Ver mis programas",
      icon: ShieldPlus,
      color: "bg-blanco-azulado text-verde-salud",
      route: "/dashboard/patient/my-programs",
    },
    {
      title: "Ver historial de citas",
      icon: History,
      color: "bg-blanco-azulado text-tiffany",
  ...
  return (
    <div className="space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-10">
      ...
      <section className="space-y-6">
        <h1 className="text-3xl font-black text-petroleo dark:text-white px-2 tracking-tight">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          {quickActions.map((action, i) => (
            <Card
              ...
              className="group cursor-pointer hover:shadow-md transition-all rounded-[2rem] border-zinc-100 dark:border-zinc-800 overflow-hidden"
            >
              <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                <div
                  className={`w-14 h-14 rounded-2xl ${action.color} flex items-center justify-center group-hover:scale-110 transition-transform`}
                >
                  <action.icon className="w-7 h-7" />
                </div>
                <span className="text-sm font-bold text-petroleo dark:text-blue-400">
                  {action.title}
                </span>
              </CardContent>
            </Card>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between px-2">
          <h2 className="text-xl font-bold text-petroleo dark:text-white">
            Tus próximas citas
          </h2>
          <Button
            variant="link"
            className="text-sm font-bold text-celeste dark:text-blue-400 flex items-center gap-1 p-0 h-auto"
          >
        ...
        <Card className="py-16 rounded-[2rem] border-dashed border-zinc-200 dark:border-zinc-800 shadow-none">
          <CardContent className="flex flex-col items-center justify-center text-center p-0">
            ...
            <p className="text-petroleo/50 dark:text-zinc-400 font-bold tracking-tight">
      ...
      {/* Programs Section */}
      <section className="space-y-6">
        <h2 className="text-xl font-bold text-petroleo dark:text-white px-2">
          Te ofrecemos los siguientes programas:
        </h2>
          ...
          <Card className="rounded-[2.5rem] border-zinc-100 dark:border-zinc-800 shadow-sm hover:shadow-md transition-all group overflow-hidden">
            <CardContent className="p-5 sm:p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6">
              ...
              <div className="space-y-2 flex-1 w-full text-center sm:text-left">
                <h3 className="text-lg sm:text-xl font-bold text-petroleo dark:text-white">
                  Programa Viva +
                </h3>
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">
                  Un programa pre-pago que cubre parte de los gastos de
                ...
                <div className="pt-2 flex items-center justify-between gap-4">
                  <div className="text-left">
                    ...
                    <span className="text-xl sm:text-2xl font-semibold text-verde-salud dark:text-blue-400">
                      S/ 31.5
                    </span>
                  </div>
                  <Button
          ...
          <Card className="rounded-[2.5rem] border-zinc-100 dark:border-zinc-800 shadow-sm hover:shadow-md transition-all group overflow-hidden">
            <CardContent className="p-5 sm:p-6 md:p-8 flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-6">
              ...
              <div className="space-y-2 flex-1 w-full text-center sm:text-left">
                ...
                <p className="text-xs text-zinc-500 dark:text-zinc-400 leading-relaxed font-medium">
                  Un programa integral que te cuida antes, durante y después del
                  embarazo.
                </p>
                <div className="pt-2 flex items-center justify-between gap-4">
                  <div className="text-left">
